...
#atribute
 path('<slug:slug_character>/atribute/add/<int:pk_realm>/', views.AtributeAd.as_view(), name='atribute-add' ),
...
#skill
 ...
 path('<slug:slug_character>/skill/add/newskill/', views.Skill.as_view(), name='newskill-add' ),
