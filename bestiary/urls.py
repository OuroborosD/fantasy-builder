...
urlpatterns = [
    path('', views.BestiaryList.as_view(), name='beastiary-list'),
    path('add/', views.BeastiryAdd.as_view(), name='beastiary-add'),
    path('<slug:slug_beast>/', views.BeastDetail.as_view(), name='beastiary'),
    path('<slug:slug_beast>/edit', views.BeastiryEdit.as_view(), name='beastiary-edit'),
    path('<slug:slug_beast>/loot/', views.MonsterLootAdd.as_view(), name='beastloot-add'),
    path('<slug:slug_beast>/loot/add/', views.LootAdd.as_view(), name='loot-add'),
    path('<slug:slug_beast>/loot/<int:pk_loot>/edit/', views.MonsterLootEdit.as_view(), name='beastloot-edit'),
    path('<slug:slug_beast>/loot/<int:pk_loot>/delete/', views.montersLootDelete, name='beastloot-delete'),
